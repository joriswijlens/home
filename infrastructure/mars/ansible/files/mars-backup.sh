#!/bin/bash
# Mars Home Assistant backup script for Scaleway Object Storage
...
REMOTE="scaleway:com-smartworkx-mars-backup"
LOG_FILE="/var/log/mars-backup.log"
...
log "Starting Mars Home Assistant incremental backup"
